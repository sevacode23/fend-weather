...
const LinkImage = styled(Image)`
  ...
  align-items: center;
`;
const LinkImageBorder = styled.div`
...
const ConnectLinksContainer = styled.div`
  margin-left: 10px;
  display: flex;
`;
const PartnerLinksContainer = styled.div`
  display: flex;
  align-items: center;
...
const ResponsibilityText = styled.p`
  ...
  text-align: center;
`;
const GeorgiaAccessContainer = styled.div`
  margin-top: 10px;
  display: flex;
  justify-content: center;
  align-items: center;
...
export const Footer = () => (
  <Root>
    <WidthContainer>
      <TopContainer>
        <ConnectContainer>
          ...
          <ConnectLinksContainer>
            <LinkImageBorder>
              <LinkImage file="facebook" width="20px" />
            </LinkImageBorder>
            <LinkImageBorder>
              <LinkImage file="twitter" width="20px" />
            </LinkImageBorder>
            <LinkImageBorder>
              <LinkImage file="instagram" width="20px" />
            </LinkImageBorder>
            <LinkImageBorder>
              <LinkImage file="youtube" width="20px" />
            </LinkImageBorder>
          </ConnectLinksContainer>
        </ConnectContainer>
      ...
      <DataRights>Data Rights</DataRights>
      <CopyrightText>
